                ...
                <div className="relative inline-block mb-4">
                  <div className="relative h-32 w-32 rounded-full overflow-hidden border-4 border-white dark:border-gray-700 shadow-lg mx-auto">
                    {avatarPreview || user?.avatar ? (
                      ...
                      <div className="h-full w-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
                  ...
                  <label
                    ...
                    className="absolute bottom-1 right-1 p-2 bg-purple-600 text-white rounded-full hover:bg-purple-700 cursor-pointer shadow-md transition-colors"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              ...
              <form onSubmit={handleUpdatePhone}>
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {updatingPhone ? (
                    <>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-900 dark:text-white pr-12"
                      required
                    />
                    <button
                      type="button"
