            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <div className="text-center">
                {user?.avatar ? (
                  ...
                  <div className="h-24 w-24 rounded-full mx-auto mb-4 bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-3xl font-bold">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              ...
              <form onSubmit={handleUpdatePhone}>
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {updatingPhone ? (
                    <>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-900 dark:text-white pr-12"
                      required
                    />
                    <button
                      type="button"
