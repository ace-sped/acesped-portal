...
export default function RecommendationPage() {
    ...
    const [currentUser, setCurrentUser] = useState<{ signature?: string; firstname?: string; surname?: string } | null>(null);
                            ...
                            <div className="bg-gray-500 p-8 rounded-xl shadow-inner overflow-auto h-[800px] flex items-start justify-center">
                                ...
                                >
                                    ...
                                    <div className="mt-12">
                                        ...
                                        <p className="font-bold">{currentUser ? `${currentUser.firstname || ''} ${currentUser.surname || ''}` : '[Deputy Center Leader Name]'}</p>
                                        <p>Deputy Centre Leader, ACE-SPED</p>
