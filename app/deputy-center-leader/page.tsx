...
export default function DeputyCenterLeaderDashboard() {
  ...
  const fetchDashboardStats = async () => {
    try {
      const response = await fetch('/api/deputy-center-leader/stats');
  ...
  const fetchRecentUsers = async () => {
    try {
      const response = await fetch('/api/deputy-center-leader/users/recent');
      const data = await response.json();
      if (data.success) {
      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            Deputy Center Leader Dashboard
          </h1>
