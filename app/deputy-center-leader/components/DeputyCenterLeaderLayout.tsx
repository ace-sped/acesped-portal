...
interface DeputyCenterLeaderLayoutProps {
...
export default function DeputyCenterLeaderLayout({ children }: DeputyCenterLeaderLayoutProps) {
  ...
  const getDisplayName = () => {
    if (!currentUser) return 'Deputy Center Leader';
  ...
  const navigation = [
    { name: 'Dashboard', href: '/deputy-center-leader', icon: LayoutDashboard },
    { name: 'Applicants', href: '/deputy-center-leader/applicants', icon: UserPlus },
    { name: 'IVET Applicants', href: '/deputy-center-leader/skill-applicants', icon: ClipboardList },
    { name: 'Admission Exercise', href: '/deputy-center-leader/admission-exercise', icon: FileText },
    { name: 'Students', href: '/deputy-center-leader/students', icon: GraduationCap },
    { name: 'Lecturers', href: '/deputy-center-leader/lecturers', icon: Users },
    { name: 'Users', href: '/deputy-center-leader/users', icon: Users },
    { name: 'Recommendations', href: '/deputy-center-leader/recommendation', icon: FileText },
    { name: 'Statement of Results', href: '/deputy-center-leader/statement-of-results', icon: FileText },
    { name: 'Manage News', href: '/deputy-center-leader/news', icon: Newspaper },
    { name: 'Manage Team', href: '/deputy-center-leader/team', icon: UserCircle },
    { name: 'Settings', href: '/deputy-center-leader/settings', icon: Settings },
  ];
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <Link href="/" className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Deputy Leader</p>
              </div>
            </Link>
          </div>
              ...
              <div className="flex items-center min-w-0 flex-1">
                ...
                <div className="ml-3 min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 truncate">
                    {loadingUser ? '...' : currentUser?.email || 'deputy@aceportal.com'}
                  </p>
                </div>
              </div>
              <button
