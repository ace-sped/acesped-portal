...
export default function SupportLetterPage() {
    ...
    const selectStudent = (student: Student) => {
        ...
        const defaultBody = `This is to certify that ${student.name}, with matriculation number ${student.matricNumber || '[Matric Number]'}, is a bona fide student of the Africa Centre of Excellence for Sustainable Power and Energy Development (ACE-SPED), University of Nigeria, Nsukka.

${pronouns.sub.charAt(0).toUpperCase() + pronouns.sub.slice(1)} is currently enrolled in the ${student.program} program. This letter is issued to support ${pronouns.pos} application for [Purpose of Support Letter].

Any assistance rendered to ${pronouns.obj} would be highly appreciated.

Please do not hesitate to contact me should you require any further validation.`;
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: `Support_Letter_${selectedStudent?.name || 'Letter'}`,
    });
        ...
        <CenterLeaderLayout>
            ...
            <div className="p-8 max-w-screen-2xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Support Letter</h1>
                        <p className="text-gray-600 dark:text-gray-400 mt-1">Generate official support letters for students</p>
                    </div>
                    {selectedStudent && (
                        <button
                ...
                {!selectedStudent ? (
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 max-w-2xl mx-auto text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6">Search for a student to generate a support letter for.</p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g. British High Commission"
                                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-purple-500 focus:border-purple-500"
                                        />
                                    </div>
                            ...
                            <div className="bg-gray-500 p-8 rounded-xl shadow-inner overflow-auto h-[800px] flex items-start justify-center">
                                ...
                                >
                                    ...
                                    <div className="mb-6 font-bold uppercase underline text-center">
                                        LETTER OF SUPPORT FOR {selectedStudent.name.toUpperCase()}
                                    </div>
